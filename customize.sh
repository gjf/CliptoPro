...
SKIPUNZIP=1
unzip -o "$ZIPFILE" remove -d $MODPATH >&2
if [ -d /data/data/com.wb.clipboard.pro/ ]; then
	...
	ui_print "Magic is done. No need to reboot. Start CliptoPro and use."
else
	abort "Please install CliptoPro first!"
fi
